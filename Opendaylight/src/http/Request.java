...
public class Request {
	...
	public Request(String username,String passwd){
	...
	public String[] Put_request(String url,com.alibaba.fastjson.JSONObject jsondata){
	...
	public String[] Delete_request(String url){
 	...
 	//Post 请求
	public String[] Post_request(String url,com.alibaba.fastjson.JSONObject jsondata){
		String [] resultStrings=new String[2]; 
		String authStr = username + ":" + passwd;
		 String encoding=Base64.encodeBase64String(authStr.getBytes());
		 CloseableHttpClient httpClient = HttpClients.createDefault();
